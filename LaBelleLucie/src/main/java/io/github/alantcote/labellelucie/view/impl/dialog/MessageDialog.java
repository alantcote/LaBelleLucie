...
public class MessageDialog {
	...
	public static final String INFO_ICON_RESOURCE = "/com/sun/java/swing/plaf/windows/icons/Inform.gif";
	...
	public void show(Window owner, String title, String message, Color background) {
	...
	/**
	 * Show a modal dialog with multiple response options. Waits for a response,
	 * returning the response option chosen.
	 * 
	 * @param owner                 the window relative to which the dialog is modal
	 *                              and positioned.
	 * @param message               the object to display - must be a
	 *                              <code>String</code> or a <code>Node</code>.
	 * @param selectionValues       the response options - each must be a
	 *                              <code>String</code> (used as the text on a
	 *                              <code>Button</code>) or a <code>Button</code>
	 *                              (used as-is) - the dialog is closed when one of
	 *                              these is selected.
	 * @param title                 the title of the dialog.
	 * @param defaultSelectionValue the default response.
	 * @return the selected response option.
	 */
	public Object showInputDialog(Window owner, String title, Object message, Object[] selectionValues,
			Object defaultSelectionValue) {
		...
		for (Object selVal : selectionValues) {
			...
			if (finalSelVal instanceof Button) {
				...
				throw new IllegalArgumentException("selectionValues[i] must be a String or a Button");
			}
...
//		dialog.setLeft(iconNode);
	...
	protected Stage createStage(Window owner, String title, String message, Color background) {
		final Stage stage = new Stage();
...
//		stage.initStyle(StageStyle.UTILITY);
	...
	protected Node messageNode(Object message) throws IllegalArgumentException {
		...
		if (message instanceof Node) {
			...
			throw new IllegalArgumentException("message must be a String or a Node");
		}
