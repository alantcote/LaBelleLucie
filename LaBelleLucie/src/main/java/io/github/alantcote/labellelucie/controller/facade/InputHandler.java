...
/**
 * Specification for an input handler.
 * 
 * There are methods listed here that probably do not belong. It is reasonable
 * to argue that this interface should be cognizant of user input events, only,
 * and should know nothing about the semantics of those events. This should be a
...
public interface InputHandler {
	 ...
	 * 
	 * It is arguable that this does not belong here.
	 * 
	...
	/**
	 * Called during a drag, when the mouse is over the region corresponding to a
	 * given card.
	 * 
	 * @param card the card.
	 */
	...
	/**
	 * Called when the mouse has entered the region corresponding to a given card.
	 * 
	 * @param card the card.
	 */
