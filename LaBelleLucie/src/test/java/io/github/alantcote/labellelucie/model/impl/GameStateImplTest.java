...
//			oneOf(mockGameStateImpl).reset();
		...
		GameStateImpl fixture = new GameStateImpl() {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#reset()
			 */
			@Override
			public void reset() {
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newFan()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newFanArray(int)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newIntegerProperty()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newObjectProperty_Deck()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newObjectProperty_GameSummary(io.github.alantcote.labellelucie.model.facade.GameSummary)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newPack()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#newUndoManager()
			 */
			@Override
	...
	public void testGameStateImpl() {
		...
		GameStateImpl fixture = new GameStateImpl() {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#inizMembers()
			 */
			@Override
...
//			oneOf(mockGameStateImpl).reset();
	...
	public void testReset() {
		...
		GameStateImpl fixture = new GameStateImpl() {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.model.impl.GameStateImpl#dealTableau(net.sf.cotelab.playingcards.Deck)
			 */
			@Override
