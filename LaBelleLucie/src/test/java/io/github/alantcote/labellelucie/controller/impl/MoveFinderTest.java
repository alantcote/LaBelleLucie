...
public class MoveFinderTest {
	...
	public void testFindMoves() {
		MoveFinder fixture = new MoveFinder(mockGameState) {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#findSimpleMoves()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#newListOfMove()
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#newMove(int, int, io.github.alantcote.labellelucie.controller.impl.MoveType)
			 */
			@Override
...
//		final Move mockMove = context.mock(Move.class, "mockMove");
	...
	public void testFindMovesToTableau() {
		MoveFinder fixture = new MoveFinder(mockGameState) {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#findMoveToFoundation(int)
			 */
			@Override
	...
	public void testFindMoveToFoundation() {
		MoveFinder fixture = new MoveFinder(mockGameState) {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#canPlayOnFoundation(net.sf.cotelab.playingcards.Card, net.sf.cotelab.playingcards.Card)
			 */
			@Override
	...
	public void testFindMoveToTableau() {
		MoveFinder fixture = new MoveFinder(mockGameState) {
			/* (non-Javadoc)
			 * @see io.github.alantcote.labellelucie.controller.impl.MoveFinder#canPlayOnTableau(net.sf.cotelab.playingcards.Card, net.sf.cotelab.playingcards.Card)
			 */
			@Override
