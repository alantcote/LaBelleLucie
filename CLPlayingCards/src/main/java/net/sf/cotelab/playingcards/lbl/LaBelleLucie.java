package net.sf.cotelab.playingcards.lbl;
...
import net.sf.cotelab.playingcards.lbl.controller.facade.Controller;
import net.sf.cotelab.playingcards.lbl.controller.impl.ControllerImpl;
import net.sf.cotelab.playingcards.lbl.model.facade.GameState;
import net.sf.cotelab.playingcards.lbl.model.impl.GameStateImpl;
import net.sf.cotelab.playingcards.lbl.view.facade.View;
import net.sf.cotelab.playingcards.lbl.view.impl.ViewImpl;
