...
public class MathFunctionsTest {
	...
	public void testEnglishNumber() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber(value[i]);
...
//				"Long.MIN_VALUE = " + MyMath.englishNumber(Long.MIN_VALUE));
	...
	public void testEnglishNumber1_19() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber1_19(value[i]);
		...
		try {
			...
			String actual = MathFunctions.englishNumber1_19(0);
			fail("no exception");
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber1_19(20);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
	...
	public void testEnglishNumber1_99() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber1_99(value[i]);
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber1_99(0);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber1_99(100);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
	...
	public void testEnglishNumber1_999() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber1_999(value[i]);
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber1_999(0);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber1_999(1000);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
	...
	public void testEnglishNumber100_999() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber100_999(value[i]);
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber100_999(99);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber100_999(1000);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
	...
	public void testEnglishNumber20_99() {
		...
		for (int i = 0; i < value.length; ++i) {
			String actual = MathFunctions.englishNumber20_99(value[i]);
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber20_99(19);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
		...
		try {
			@SuppressWarnings("unused")
			String actual = MathFunctions.englishNumber20_99(100);
			fail("no exception");
		} catch (IllegalArgumentException e) {
			// nothing - this is expected
		}
	...
	public void testFactorial() {
		...
		for (int i = 0; i < expected.length; ++i) {
			double actual = MathFunctions.factorial((double) i);
	...
	public void testFactors() {
		...
		for (int i = 0; i < prod.length; ++i) {
			long[] actual = MathFunctions.factors(prod[i]);
			
			assertEquals(MathFunctions.stringify(fact[i]), MathFunctions.stringify(actual));
		}
	}
	...
	public void testGcd() {
		...
		for (int i = 0; i < expected.length; ++i) {
			long actual = MathFunctions.gcd(params[i][0], params[i][1]);
	...
	public void testLcm() {
		...
		for (int i = 0; i < expected.length; ++i) {
			long actual = MathFunctions.lcm(params[i][0], params[i][1]);
	...
	public void testProperDivisors() {
		...
		for (int i = 0; i < prod.length; ++i) {
			long[] actual = MathFunctions.properDivisors(prod[i]);
	...
	public void testMaxPathSum() {
		...
		long expected = 23;
		long actual = MathFunctions.maxPathSum(triangle);
	...
	public void testProduct() {
		...
		for (int i = 0; i < prod.length; ++i) {
			long actual = MathFunctions.product(fact[i]);
	...
	public void testStringify() {
		...
		for (int i = 0; i < expected.length; ++i) {
			String actual = MathFunctions.stringify(fact[i]);
	...
	public void testSum() {
		...
		for (int i = 0; i < sum.length; ++i) {
			long actual = MathFunctions.sum(term[i]);
	...
	public void testZeller() {
		...
		int actual = MathFunctions.zeller(year, month, day);
